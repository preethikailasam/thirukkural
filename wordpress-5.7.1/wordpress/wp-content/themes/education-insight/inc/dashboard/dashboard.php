...
function education_insight_gettingstarted() {    	
	add_theme_page( esc_html__('Education Insight', 'education-insight'), esc_html__('Education Insight', 'education-insight'), 'edit_theme_options', 'education-insight-guide-page', 'education_insight_guide');   
}
...
function education_insight_guide() {
	...
	$theme = wp_get_theme( 'education-insight' ); ?>

	<div class="getting-started__header">
		<div class="col-md-10">
			<h2><?php esc_html_e( 'Education Insight', 'education-insight' ); ?></h2>
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('To step the education theme follow the below steps.','education-insight'); ?></p>
					...
					<p><?php esc_html_e('Go to dashboard >> Pages >> Add New Page >> Select "Custom Home Page" from page attribute >> Publish it.','education-insight'); ?></p>
			...
			<div class="col-md-3">
				<h3><?php esc_html_e('Premium Education Theme','education-insight'); ?></h3>
				<img class="education_insight_img_responsive" style="width: 100%;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.png">
				<div class="pro-links">
					<hr>
			    	<a class="button-primary" href="<?php echo esc_url( EDUCATION_INSIGHT_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'education-insight'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( EDUCATION_INSIGHT_BUY_PRO ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'education-insight'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( EDUCATION_INSIGHT_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'education-insight'); ?></a>
					<hr>
				</div>
